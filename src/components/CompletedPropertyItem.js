    ...
    return (
        ...
        >
            ...
            <div className="flex flex-row justify-between mx-[20px] mb-[15px]">
                ...
                <button className="bg-[#377eff] px-[20px] py-[5px] text-sm font-bold text-white">View Details</button>
            </div>
        </div>
    );
};

export default CompletedPropertyItem;